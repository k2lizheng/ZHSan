    ...
    public class ArchitectureList : GameObjectList
    {
        public void AddArchitectureWithEvent(Architecture architecture, bool add = true)
        {
            ...
            //{
                ...
                architecture.OnZhibao += new Architecture.Zhibao(this.architecture_OnZhibao);
            //}
        }
        ...
        public void architecture_OnZhibao(Treasure treasure, Person leader)
        {
            Session.MainGame.mainGameScreen.Zhibao(treasure, leader);
        }
