...
namespace GameObjects
{
    ...
    public class Facility : GameObject
    {
        ...
        public int Days
        {
            get
            {
                return (int)Math.Ceiling((double)this.Kind.Days / (double)Session.Parameters.DayInTurn);
            }
        }
        ...
        public int DaysText
        {
            get
            {
                return (int)Math.Ceiling((double)this.Kind.Days / (double)Session.Parameters.DayInTurn) * Session.Parameters.DayInTurn;
            }
        }
