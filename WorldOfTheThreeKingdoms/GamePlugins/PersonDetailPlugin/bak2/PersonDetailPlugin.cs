...
namespace PersonDetailPlugin
{
    ...
    public class PersonDetailPlugin : GameObject, IPersonDetail, IBasePlugin, IPluginXML, IPluginGraphics
    {
        ...
        public void LoadDataFromXMLDocument(string filename)
        {
            ...
            node = nextSibling.ChildNodes.Item(0x3d);
            this.personDetail.Stunt0ID0Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x3e);
            this.personDetail.Stunt1ID1Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x3f);
            this.personDetail.Stunt2ID2Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x40);
            this.personDetail.Stunt3ID3Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x41);
            this.personDetail.Stunt4ID4Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x42);
            this.personDetail.Stunt5ID5Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x43);
            this.personDetail.Stunt6ID6Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x44);
            this.personDetail.Stunt7ID7Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x45);
            this.personDetail.Stunt8ID8Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(70);
            this.personDetail.Stunt9ID9Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x47);
            this.personDetail.Stunt10ID10Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x48);
            this.personDetail.Stunt11ID11Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x49);
            this.personDetail.Stunt12ID12Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x4a);
            this.personDetail.Stunt13ID13Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x4b);
            this.personDetail.Stunt14ID14Client = StaticMethods.LoadRectangleFromXMLNode(node);
            node = nextSibling.ChildNodes.Item(0x4c);
            this.personDetail.Stunt15ID15Client = StaticMethods.LoadRectangleFromXMLNode(node);
            /*
