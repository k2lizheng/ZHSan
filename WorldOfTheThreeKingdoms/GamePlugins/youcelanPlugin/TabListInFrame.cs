                        ...
                        if (gameObjectByPosition != null)
                        {
                            ...
                            else
                            {
                                ...
                                else if (gameObjectByPosition is Architecture)
                                {
                                    ...
                                    Session.MainGame.mainGameScreen.LastArchitecture = gameObjectByPosition as Architecture;
                        ...
                        if (gameObjectByPosition != null)
                        {
                            ...
                            else
                            {
                                ...
                                else if (gameObjectByPosition is Architecture)
                                {
                                    ...
                                    Session.MainGame.mainGameScreen.JumpTo((gameObjectByPosition as Architecture).Position, gameObjectByPosition as Architecture);
                                }
                                else if (gameObjectByPosition is Military)
                                {
                                    Session.MainGame.mainGameScreen.JumpTo((gameObjectByPosition as Military).Position);
