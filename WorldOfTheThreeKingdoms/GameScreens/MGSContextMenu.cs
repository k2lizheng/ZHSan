        ...
        private void HandleContextMenuResult(ContextMenuResult result)
        {
            ...
            switch (result)
            {
                ...
                case ContextMenuResult.Monarch_ZhaoXianBang_GenerateOfficer:
                    ...
                    break;
                case ContextMenuResult.Monarch_ZhaoXianBang_ZhiBao://制作宝物
                    //this.CurrentArchitecture.DoZhiBao();
            ...
            case ContextMenuResult.Monarch_ZhaoXianBang_DengYong: //登用
                ...
                */
                ...
                case ContextMenuResult.TroopIdle:
                    ...
                    this.CurrentTroop.TargetArchitecture = null;
                    this.CurrentTroop.TargetTroop = null;
                    this.CurrentTroop.AttackTargetKind = TroopAttackTargetKind.目标;
                ...
                case ContextMenuResult.TroopTreasure:
                    ...
                    break;
                case ContextMenuResult.AllTroopInfluences:
                    this.ShowTabListInFrame(UndoneWorkKind.Frame, FrameKind.Influence, FrameFunction.Browse, true, true, false, false, this.CurrentTroop.GetAllInfluencesList(), null, "", "");
                    break;
