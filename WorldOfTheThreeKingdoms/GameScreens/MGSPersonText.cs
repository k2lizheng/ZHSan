...
namespace WorldOfTheThreeKingdoms.GameScreens
{
    partial class MainGameScreen : Screen
    {
        ...
        public override void PersonBeKilled(Person person, Architecture location)
        {
            ...
            if (((Session.Current.Scenario.CurrentPlayer == null) ||person.BelongedFaction == Session.Current.Scenario.CurrentPlayer || Session.GlobalVariables.SkyEye))
            {
                this.Plugins.tupianwenziPlugin.SetPosition(ShowPosition.Bottom, Session.MainGame.mainGameScreen);
...
#pragma warning restore CS0168 // The variable 'msg' is declared but never used
            ...
            if (((Session.Current.Scenario.CurrentPlayer == null) || Session.Current.Scenario.IsCurrentPlayer(person.BelongedFaction)) || Session.GlobalVariables.SkyEye)
            {
                ...
                else
                {
                    switch (resultPack.Result)
                    {
                        ...
                        case SearchResult.宝物:
                            person.TextResultString = resultPack.FoundTreasure.Name;
                            this.Plugins.PersonBubblePlugin.AddPerson(person, architecture.Position, TextMessageKind.PersonTreasureFound, "PersonTreasureFound");
                            this.Plugins.GameRecordPlugin.AddBranch(person, "PersonTreasureFound", person.Position);
                            break;
                    }
        ...
        */
        ...
        public override void Zhibao(Treasure t, Person q)
        {
            if (Session.Current.Scenario.IsCurrentPlayer(q.BelongedFaction))
            {
                t.TextResultString = t.Name + t.InfluenceString;
                q.TextResultString = q.Name;            
                this.Plugins.tupianwenziPlugin.SetGameObjectBranch(q, t, TextMessageKind.ZhiBao, "ZhiBao", "ZhiBao.jpg", "");
                this.Plugins.tupianwenziPlugin.SetPosition(ShowPosition.Bottom, Session.MainGame.mainGameScreen);
                this.Plugins.tupianwenziPlugin.IsShowing = true;            
            }
        }
